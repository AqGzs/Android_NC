  ...
  class _EditProfileScreenState extends State<EditProfileScreen> {
    ...
    Future<void> _updateUserDetails() async {
      if (_formKey.currentState!.validate()) {
        ...
        try {
          User updatedUser = await _userService.updateUserDetails(
            widget.userId,
            widget.token,
            {
              'name': _name,
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                CircleAvatar(
                  radius: 50,
                  backgroundImage: NetworkImage(widget.user.imageUrl ?? 'https://th.bing.com/th/id/OIP.JBpgUJhTt8cI2V05-Uf53AHaG1?w=179&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7'),
                  child: Align(
